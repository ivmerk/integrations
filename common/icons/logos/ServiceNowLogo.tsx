...
export const ServiceNowLogo = ({ backgroundColor = '#FFFFFF', ...props }: Props) => (
  <svg
    width="129.8"
    height="19.25"
  ...
  >
    ...
    >
      ...
      >
        ...
        />
        <polygon
          transform="translate(-.3 -.5379)" points="48.3 6.6 42.4 19.5 40 19.5 34.1 6.6 37.6 6.6 41.2 14.5 44.7 6.6"
        />
        <path
