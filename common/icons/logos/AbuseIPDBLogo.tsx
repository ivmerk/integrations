  ...
  >
    <defs>
      <linearGradient id="f" x1="54.759" x2="49.053" y1="600.57" y2="631.41"
                      gradientTransform="scale(1.5608 .64069)" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" stopOpacity=".175" offset="0" />
        <stop stopColor="#fff" stopOpacity=".375" offset="1" />
      </linearGradient>
      <linearGradient id="g" x1="32.103" x2="56.402" y1="808.54" y2="808.54"
                      gradientTransform="scale(2.195 .45558)" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" stopOpacity=".175" offset="0" />
        <stop stopColor="#fff" stopOpacity=".375" offset="1" />
      </linearGradient>
    ...
    <svg x="10" y="0" width="100" height="100" version="1.1" viewBox="0 0 162.18244 162.18244"
      ...
      <g transform="translate(-16.984 -331)">
        <g transform="matrix(1.0215 0 0 .99183 -1.0406 3.2411)" fillRule="evenodd">
